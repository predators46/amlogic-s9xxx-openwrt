...
rebuild_firmware() {
	...
	\
	dnsmasq-full kmod-mac80211 wpad-basic-mbedtls \
        \
	dnsmasq-full ipset iptables iptables-mod-conntrack-extra iptables-mod-iprange iptables-mod-tproxy kmod-ipt-nat luci-app-passwall2 xray-core \
	\
        -dnsmasq \
        \
        ${config_list} \
