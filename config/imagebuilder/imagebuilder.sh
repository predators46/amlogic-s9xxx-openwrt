...
custom_packages() {
    ...
    mkdir -p packages && wget https://github.com/firmwarecostum/mosdns/releases/download/zm/mosdns_ipk_ARMSR.zip
...
rebuild_firmware() {
    ...
    sudo wget https://github.com/predators46/amlogic-s9xxx-openwrt/releases/download/OpenWrt_imagebuilder_openwrt_24.10.5_2026.03/openwrt_official_amlogic_s905x_k6.6.129_2026.03.11.img.gz
    sudo gunzip openwrt_official_amlogic_s905x_k6.6.129_2026.03.11.img.gz
    sudo mkdir armbian
    sudo losetup -P -f --show openwrt_official_amlogic_s905x_k6.6.129_2026.03.11.img
    sudo ls /dev/loop0*
    ...
    sudo xz --compress openwrt_official_amlogic_s905x_k6.6.129_2026.03.11.img
