...
rebuild_firmware() {
    ...
    sudo wget https://github.com/predators46/amlogic-s9xxx-openwrt/releases/download/OpenWrt_imagebuilder__2025.10/openwrt_amlogic_s905x_k6.6.113_2025.10.23.img.gz
    sudo gunzip openwrt_amlogic_s905x_k6.6.113_2025.10.23.img.gz
    sudo mkdir armbian
    sudo losetup -P -f --show openwrt_amlogic_s905x_k6.6.113_2025.10.23.img
    sudo ls /dev/loop0*
    ...
    sudo xz --compress openwrt_amlogic_s905x_k6.6.113_2025.10.23.img
