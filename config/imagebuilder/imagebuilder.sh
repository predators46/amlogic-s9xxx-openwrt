...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        \
        python3-homeassistant python3-aiohasupervisor python3-infrared-protocols python3-pandas \
        \
        -dnsmasq \
        \
    ...
    sudo mkdir armbian
    sudo losetup -P -f --show openwrt_official_amlogic_s905x_k6.12.77_2026.03.15.img
    sudo ls /dev/loop0*
    ...
    sudo xz --compress openwrt_official_amlogic_s905x_k6.12.77_2026.03.15.img
