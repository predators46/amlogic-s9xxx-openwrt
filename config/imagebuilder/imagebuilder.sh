...
rebuild_firmware() {
    ...
    sudo wget https://github.com/predators46/amlogic-s9xxx-openwrt/releases/download/OpenWrt_imagebuilder__2025.07/openwrt_amlogic_s905x_k6.6.99_2025.07.27.img.gz
    sudo gunzip openwrt_amlogic_s905x_k6.6.99_2025.07.27.img.gz
    sudo mkdir armbian
    sudo losetup -P -f --show openwrt_amlogic_s905x_k6.6.99_2025.07.27.img
    sudo ls /dev/loop3*
    ...
    sudo xz --compress openwrt_amlogic_s905x_k6.6.99_2025.07.27.img
