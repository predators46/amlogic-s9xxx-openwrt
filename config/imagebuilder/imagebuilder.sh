...
rebuild_firmware() {
    ...
    sudo wget https://github.com/predators46/amlogic-s9xxx-openwrt/releases/download/OpenWrt_imagebuilder_openwrt_24.10.4_2025.11/openwrt_amlogic_s905x_k6.6.71_2025.11.07.img.gz
    sudo gunzip openwrt_amlogic_s905x_k6.6.71_2025.11.07.img.gz
    sudo mkdir armbian
    sudo losetup -P -f --show openwrt_amlogic_s905x_k6.6.71_2025.11.07.img
    sudo ls /dev/loop0*
    ...
    sudo xz --compress openwrt_amlogic_s905x_k6.6.71_2025.11.07.img
