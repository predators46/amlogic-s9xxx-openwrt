...
rebuild_firmware() {
    ...
    my_packages="\
        ...
        \
        luci-app-openclash luci-app-tailscale bash iptables dnsmasq-full curl ca-bundle ipset ip-full iptables-mod-tproxy iptables-mod-extra ruby ruby-yaml kmod-tun unzip luci-compat luci luci-base \
        \
        dnsmasq-full \
        \
        -dnsmasq \
